$(document).ready(function() {
  $("input").on("keyup keydown keypress change", function(e) {
    ...
    if (family_size != "" && income != "") {
       ...
       */
      if ((income >= 0 && income <= 100750) && (family_size == 8)) {
        $("#yes").addClass("active");
      } else if ((income >= 0 && income <= 79465) && (family_size == 7)) {
        $("#yes").addClass("active");
      } else if ((income >= 0 && income <= 88550) && (family_size == 6)) {
        $("#yes").addClass("active");
      } else if ((income >= 0 && income <= 82450) && (family_size == 5)) {
        $("#yes").addClass("active");
      } else if ((income >= 0 && income <= 76300) && (family_size == 4)) {
        $("#yes").addClass("active");
      } else if ((income >= 0 && income <= 68700) && (family_size == 3)) {
        $("#yes").addClass("active");
      } else if ((income >= 0 && income <= 61050) && (family_size == 2)) {
        $("#yes").addClass("active");
      } else if ((income >= 1 && income <= 53450) && (family_size == 1)) {
        $("#yes").addClass("active");
